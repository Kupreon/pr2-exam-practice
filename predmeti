...
bool ValidirajLozinku(string lozinka) {
    ...
    */
    ...
    regex pravilo("(?=.{6,7})[*_][0-9][a-z][ ]?[A-Z][0-9][a-z]");
...
const char* GetOdgovorNaPrvoPitanje() {
    ...
    return "Odgovor -> U javnom i zasticenom nasljedjivanju atributi su dostupni izvedenim klasama, dok u privatnom nasljedjivanju nisu.";
}
const char* GetOdgovorNaDrugoPitanje() {
    cout << "Pitanje -> Ukratko pojasnite primjenu funkcija seekg i tellg?\n";
    return "Odgovor -> Pomocu funkcije seekg mijenjamo poziciju get stream pointera, dok nam funkcija tellg govori trenutnu lokaciju get stream pointera.";
}
